...
public class TransactionReport extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tanggalLaporan1 = (TextView)rootView.findViewById(R.id.tanggallaporantransaksi1);
        tanggalLaporan2 = (TextView)rootView.findViewById(R.id.tanggallaporantransaksi2);
...
//        emptyText = (RelativeLayout)rootView.findViewById(R.id.empty_text_transaksi);
        ...
        SimpleDateFormat datedFormat = new SimpleDateFormat("EEE, dd MMM yyyy");
...
//                                transaksiWaktuPelangganAdapter.setModels(models);
    ...
    private void getDataRange(int page){
        String testUrl = API.TRANSAKSI_URL2+SavePref.readShopId(getActivity())+"?startDate="+tglsebelum.getText().toString()+"&endDate="+tglsesudah.getText().toString()+"&limit=5&page="+page;
        Log.e("res ", testUrl);
        StringRequest request = new StringRequest(
                Request.Method.GET,
                testUrl,
