...
import com.evolve.backdroplibrary.ToolbarIconClick;
...
public class BackdropContainer extends FrameLayout implements BackdropActions {
   ...
   public BackdropContainer(@NonNull Context context, @Nullable AttributeSet attrs) {
       ...
       TypedArray typedArray=context.obtainStyledAttributes(attrs, com.evolve.backdroplibrary.R.styleable.BackdropContainer,0,0);

       mMenuicon=typedArray.getDrawable(com.evolve.backdroplibrary.R.styleable.BackdropContainer_menuIcon);
       mCloseicon=typedArray.getDrawable(com.evolve.backdroplibrary.R.styleable.BackdropContainer_closeIcon);
       duration=typedArray.getInt(com.evolve.backdroplibrary.R.styleable.BackdropContainer_duration,1000);
   ...
   private int getFrontViewMargin() {
       MarginLayoutParams layoutParams = (MarginLayoutParams) getFrontview().getLayoutParams();
